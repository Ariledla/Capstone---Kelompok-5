...
# ============================================================
# NATIVE SIDEBAR TOGGLE — STABLE
# Tombol buka/tutup memakai kontrol native Streamlit, hanya distyling.
# Ini lebih stabil daripada custom sidebar JS karena layout Streamlit tetap bekerja normal.
# ============================================================

st.markdown(
    """
    <style>
    /* Bersihkan sisa tombol custom lama, tapi jangan matikan tombol native Streamlit. */
    ...
    /* Sidebar tetap ukuran nyaman saat terbuka. */
    [data-testid="stSidebar"] {
        width: 304px !important;
        min-width: 304px !important;
    ...
    /* Konten utama selalu auto-center. Saat sidebar ditutup, Streamlit otomatis memberi ruang full,
       jadi elemen utama tidak ketutup dan tidak ke-crop. */
    .block-container,
    [data-testid="stMainBlockContainer"] {
    ...
    /* Tampilkan dan bentuk ulang tombol native sidebar sebagai logo << / >>. */
    ...
    /* Posisi saat sidebar terbuka: tombol tutup ada di area kanan sidebar. */
    button[aria-label="Collapse sidebar"],
    button[title="Collapse sidebar"],
    button[aria-label="Close sidebar"],
    button[title="Close sidebar"],
    ...
    /* Posisi saat sidebar tertutup: tombol buka ada di kiri atas. */
    button[aria-label="Expand sidebar"],
    button[title="Expand sidebar"],
    button[aria-label="Open sidebar"],
    button[title="Open sidebar"],
    ...
    /* Sembunyikan ikon native/hamburger, ganti dengan logo chevron custom. */
    ...
    /* Supaya tombol native tidak meninggalkan area kosong aneh di header. */
    [data-testid="stHeader"] {
        background: transparent !important;
        height: 0 !important;
        min-height: 0 !important;
